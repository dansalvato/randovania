...
def test_connections_from_dock_blast_shield(empty_patches):
    ...
    weak_1 = DockWeakness("Weak 1", frozendict(), req_1, lock=None)
    weak_2 = DockWeakness("Weak 2", frozendict(), Requirement.trivial(), lock=DockLock(
        lock_type=DockLockType.FRONT_BLAST_BACK_BLAST,
        requirement=req_2,
    ))
